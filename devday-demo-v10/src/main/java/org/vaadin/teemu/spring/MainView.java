...
public class MainView extends VerticalLayout {
	...
	public MainView() {
		...
		/* Specific part for Vaadin 10 */

		// Stylename for first column content
		...
		// Construct the actions column with a template
		grid.addColumn(TemplateRenderer
				...
				.withEventHandler("handleRemove", beverage -> delete(beverage))).setHeader("Actions");

		showButton.addClickListener(e -> new ShoppingCartDialog(shoppingCart));

		// Add components to the view
		add(new H2("DevDay Grid Demo for Vaadin 10"), grid, new HorizontalLayout(nameEditor, saveButton), showButton);
	}
